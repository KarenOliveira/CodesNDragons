...
public class MainMenuState extends State {
	...
	public void render(Graphics g) {
		...
		handler.getGame().getImageUtils().centerImageOnPosition(g, Assets.button1[0], handler.getWidth()/2, handler.getHeight()/2, 500, 150);
		...
		//handler.getGame().getText().centerTextOnPosition(g, "Press Enter to Start",new Font("Comic Sans MS", Font.ITALIC, 40), handler.getWidth()/2, handler.getHeight()/2);
	}
